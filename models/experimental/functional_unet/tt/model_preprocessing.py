...
def create_unet_model_parameters(
    ...
    parameters.c1_2["conv_blocking_and_parallelization_config_override"] = {"act_block_h": 4 * 32}
    parameters.c1_2["use_split_reader"] = True
    parameters.c1_2["use_activation_double_buffer"] = True
    parameters.c1_2["input_channels_alignment"] = 8
    parameters.c1_2["in_place"] = True
    ...
    parameters.c6["conv_blocking_and_parallelization_config_override"] = {"act_block_h": 1 * 32}
    parameters.c6["use_split_reader"] = False
    parameters.c6["use_activation_double_buffer"] = False
    parameters.c6["input_channels_alignment"] = 8
