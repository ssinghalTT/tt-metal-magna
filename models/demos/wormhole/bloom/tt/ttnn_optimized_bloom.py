...
def preprocess_inputs(
    *,
    ...
    padded_input_ids = ttnn.from_torch(padded_input_ids, dtype=ttnn.uint32, mesh_mapper=mesh_mapper, device=device)
    ...
    alibi = ttnn.from_torch(alibi, dtype=ttnn.bfloat16, mesh_mapper=mesh_mapper, device=device)
    ...
    causal_mask = ttnn.from_torch(causal_mask, dtype=ttnn.bfloat16, mesh_mapper=mesh_mapper, device=device)
