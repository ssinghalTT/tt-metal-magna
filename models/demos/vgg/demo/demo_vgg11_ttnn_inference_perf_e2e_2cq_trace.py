...
from models.demos.vgg.demo.vgg11_test_infra import create_test_infra
...
def test_vgg11(device, use_program_cache, model_location_generator):
    torch.manual_seed(0)
    profiler.clear()
    disable_persistent_kernel_cache()
    ...
    prep_perf_report(
        model_name=f"ttnn_functional_ttnn_vgg11_{batch_size}",
