...
constexpr uint32_t dispatch_s_noc_xy = uint32_t(NOC_XY_ENCODING(DOWNSTREAM_DRONE_NOC_X, DOWNSTREAM_DRONE_NOC_Y));
...
// process_exec_buf_relay_inline_cmd while ensuring that state for dispatch_master and dispatch_drone is passed in
// during compile time.
