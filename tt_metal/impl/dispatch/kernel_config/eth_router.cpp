...
void EthRouterKernel::CreateKernel() {
    ...
    std::map<string, string> defines = {
        ...
        {"DOWNSTREAM_DRONE_NOC_X", std::to_string(hal.noc_coordinate(noc_selection_.downstream_noc, grid_size.x, 0))},
        {"DOWNSTREAM_DRONE_NOC_Y", std::to_string(hal.noc_coordinate(noc_selection_.downstream_noc, grid_size.y, 0))},
        {"SKIP_NOC_LOGGING", "1"}};
