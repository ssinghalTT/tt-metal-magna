...
void DispatchSKernel::CreateKernel() {
    ...
    std::map<string, string> defines = {
        ...
        {"DOWNSTREAM_DRONE_NOC_X", std::to_string(downstream_s_virtual_noc_coords.x)},  // Unused, remove later
        {"DOWNSTREAM_DRONE_NOC_Y", std::to_string(downstream_s_virtual_noc_coords.y)},  // Unused, remove later
    };
