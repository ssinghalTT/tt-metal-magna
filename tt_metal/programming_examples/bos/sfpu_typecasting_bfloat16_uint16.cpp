...
int main(int argc, char** argv) {
    ...
    try {
        ...
        CircularBufferConfig cb_output_config =
            CircularBufferConfig(num_output_tiles * single_tile_size, {{output_cb_index, tt::DataFormat::UInt16}})
        ...
        KernelHandle eltwise_sfpu_kernel_id = CreateKernel(
            program,
            "tt_metal/programming_examples/bos/kernels/kernel_sfpu_typecasting_bfloat16_uint16.cpp",
            core,
            ComputeConfig{
        ...
        std::vector<uint32_t> src0_vec = bos_create_linear_vector_of_bfloat16(dram_buffer_size, 1.11f, 1.11f);
        ...
        std::vector<uint32_t> golden_vec = bos_casting_bfloat16_vec_to_uint16_vec(src0_vec, transform_to_golden);
        ...
        pass &= bos_uint16_vector_comparison(golden_vec, result_vec, comparison_function);
