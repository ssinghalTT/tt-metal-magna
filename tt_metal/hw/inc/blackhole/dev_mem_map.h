...
#define MEM_SLAVE_IERISC_FIRMWARE_BASE (MEM_IERISC_FIRMWARE_BASE + MEM_ERISC_FIRMWARE_SIZE)
#define MEM_IERISC_MAP_END (MEM_SLAVE_IERISC_FIRMWARE_BASE + MEM_SLAVE_ERISC_FIRMWARE_SIZE)
...
#define MEM_SLAVE_AERISC_FIRMWARE_BASE (MEM_AERISC_FIRMWARE_BASE + MEM_ERISC_FIRMWARE_SIZE)
#define MEM_AERISC_MAP_END (MEM_SLAVE_AERISC_FIRMWARE_BASE + MEM_SLAVE_ERISC_FIRMWARE_SIZE)
...
#define SLAVE_AERISC_RESET_PC (MEM_LOCAL_BASE | 0x14008)
