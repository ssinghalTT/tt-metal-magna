...
#define MEM_DRONE_IERISC_LOCAL_SIZE (8 * 1024)
#define MEM_IERISC_FIRMWARE_SIZE (24 * 1024)
#define MEM_DRONE_IERISC_FIRMWARE_SIZE (24 * 1024)
...
#define MEM_DRONE_IERISC_FIRMWARE_BASE (MEM_IERISC_FIRMWARE_BASE + MEM_IERISC_FIRMWARE_SIZE)
#define MEM_IERISC_MAP_END (MEM_DRONE_IERISC_FIRMWARE_BASE + MEM_DRONE_IERISC_FIRMWARE_SIZE)
#define MEM_IERISC_KERNEL_SIZE (24 * 1024)
#define MEM_IERISC_INIT_LOCAL_L1_BASE_SCRATCH MEM_IERISC_MAP_END
#define MEM_DRONE_IERISC_INIT_LOCAL_L1_BASE_SCRATCH (MEM_IERISC_INIT_LOCAL_L1_BASE_SCRATCH + MEM_IERISC_LOCAL_SIZE)
#define MEM_IERISC_STACK_SIZE 1024
#define MEM_DRONE_IERISC_STACK_SIZE 1024
#define MEM_IERISC_STACK_TOP (MEM_LOCAL_BASE + MEM_IERISC_LOCAL_SIZE)
#define MEM_DRONE_IERISC_STACK_TOP (MEM_LOCAL_BASE + MEM_DRONE_IERISC_LOCAL_SIZE)

#define MEM_IERISC_BANK_TO_NOC_SCRATCH (MEM_DRONE_IERISC_INIT_LOCAL_L1_BASE_SCRATCH + MEM_DRONE_IERISC_LOCAL_SIZE)
...
#define DRONE_IERISC_RESET_PC (MEM_LOCAL_BASE | 0x14008)
