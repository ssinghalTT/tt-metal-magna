...
#define MEM_SUBORDINATE_IERISC_FIRMWARE_BASE (MEM_IERISC_FIRMWARE_BASE + MEM_ERISC_FIRMWARE_SIZE)
#define MEM_IERISC_MAP_END (MEM_SUBORDINATE_IERISC_FIRMWARE_BASE + MEM_SUBORDINATE_ERISC_FIRMWARE_SIZE)
...
#define MEM_SUBORDINATE_IERISC_STACK_SIZE (MEM_ERISC_STACK_SIZE)
#define MEM_IERISC_STACK_TOP (MEM_LOCAL_BASE + MEM_ERISC_LOCAL_SIZE)
#define MEM_SUBORDINATE_IERISC_STACK_TOP (MEM_LOCAL_BASE + MEM_SUBORDINATE_ERISC_LOCAL_SIZE)
...
#define MEM_SUBORDINATE_AERISC_FIRMWARE_BASE (MEM_AERISC_FIRMWARE_BASE + MEM_ERISC_FIRMWARE_SIZE)
#define MEM_AERISC_MAP_END (MEM_SUBORDINATE_AERISC_FIRMWARE_BASE + MEM_SUBORDINATE_ERISC_FIRMWARE_SIZE)
...
#define MEM_SUBORDINATE_AERISC_STACK_SIZE (MEM_ERISC_STACK_SIZE)
