...
#include "ttnn/operations/experimental/scatter_/scatter_enums.hpp"
#include "ttnn/types.hpp"

namespace ttnn::operations::experimnetal::scatter::detail {

void bind_scatter__operation(py::module& module) {
    auto doc =
        R"doc(
        ...
        ttnn::pybind_overload_t{
            [](const OperationType& self,
               ...
               QueueId queue_id) -> Tensor {
                return self(
                    queue_id, dim, input_tensor, index_tensor, opt_reduction, opt_out_memory_config, opt_output);
            },
