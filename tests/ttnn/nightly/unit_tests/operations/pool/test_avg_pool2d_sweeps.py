...
parameters = {
    "input_specs": [
        ...
        # [1, 1056, 14, 14, 2, 2, 2, 2, 0, 0, True, True],
        # [1, 128, 56, 56, 2, 2, 2, 2, 0, 0, True, True],
        [1, 32, 3, 3, 2, 2, 2, 2, 0, 0, True, True, None],
        # [1, 192, 56, 56, 2, 2, 2, 2, 0, 0, True, True],
        # [1, 256, 28, 28, 2, 2, 2, 2, 0, 0, True, True],
        # [1, 384, 28, 28, 2, 2, 2, 2, 0, 0, True, True],
        # [1, 512, 13, 13, 2, 2, 2, 1, 0, 0, True, True, None],
        # [1, 640, 14, 14, 2, 2, 2, 2, 0, 0, True, True],
        # [1, 896, 14, 14, 2, 2, 2, 2, 0, 0, True, True],
        # [1, 1024, 17, 17, 3, 3, 1, 1, 1, 1, True, False],
        # [1, 112, 14, 14, 2, 2, 2, 2, 0, 0, True, True],
        # [1, 1536, 8, 8, 3, 3, 1, 1, 1, 1, True, False],
        # [1, 24, 56, 56, 2, 2, 2, 2, 0, 0, True, True],
        # [1, 384, 35, 35, 3, 3, 1, 1, 1, 1, True, False],
        # [1, 40, 28, 28, 2, 2, 2, 2, 0, 0, True, True],
        # [1, 80, 14, 14, 2, 2, 2, 2, 0, 0, True, True],
    ],
    "failing_parameters": [
        # [batch_size, input_channels, input_height, input_width, kernel_height, kernel_width, stride_h, stride_w, pad_h, pad_w, ceil_mode, count_include_pad]
