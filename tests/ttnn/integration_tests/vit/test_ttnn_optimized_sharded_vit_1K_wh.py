...
from models.experimental.functional_vit.tt import ttnn_optimized_sharded_vit_1K_wh as ttnn_optimized_sharded_vit
...
@pytest.mark.parametrize("image_size", [1024])
