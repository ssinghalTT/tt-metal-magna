...
@pytest.mark.parametrize(
    "batch_size, input_height, input_width, input_channels, output_channels, filter_height, filter_width, stride_h, stride_w, pad_h, pad_w, out_pad_h, out_pad_w, config, shard_layout",
    (
        # (1, 30, 40, 512, 256, 2, 2, 2, 2, 0, 0, 0, 0, None, ttnn.TensorMemoryLayout.BLOCK_SHARDED), #passed
        # (1, 60, 80, 256, 128, 2, 2, 2, 2, 0, 0, 0, 0, {"act_block_h": 64}, ttnn.TensorMemoryLayout.BLOCK_SHARDED), #passed
        # (1, 120, 160, 128, 64, 2, 2, 2, 2, 0, 0, 0, 0, {"act_block_h": 64}, ttnn.TensorMemoryLayout.HEIGHT_SHARDED), #passed
        (
            1,
            240,
            320,
