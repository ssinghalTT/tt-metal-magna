...
run_tg_llama_70b_model_perf_tests() {
  ...
  TT_METAL_KERNELS_EARLY_RETURN=1 FAKE_DEVICE=TG LLAMA_DIR=$llama70b pytest models/demos/llama3_subdevices/tests/test_decoder_device_perf.py::test_llama_TG_perf_device_non_overlapped_dispatch ; fail+=$?
